...
public class MemberController {
	...
	public String insertMember(MemberDAO mDAO,MemberVO mVO,HttpServletRequest request)  {
	...
	public String mypage(MemberVO vo,MemberDAO mDAO,ModelAndView mav,HttpServletRequest request)  {
		HttpSession session=request.getSession();
	...
	public String updateMember(@ModelAttribute("mamber")MemberVO vo,MemberDAO mDAO,ModelAndView mav,HttpServletRequest request) {
