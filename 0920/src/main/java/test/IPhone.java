...
public class IPhone implements Phone{
	@Autowired
	private Watchs watch; // 의존관계 -> 의존성 주입 (DI)이 필요한 상태
	private int number;
...
//	 DI : 생성자 인젝션
//		public IPhone(Watchs watch) {
//			System.out.println("아이폰 객체생성완료22");
//			this.watch=watch;
//		}
	//	public IPhone(Watchs watch,int number) {
	...
	public void setWatch(Watchs watch) {
		System.out.println("Settet 호출됨 - 1 ");
		this.watch = watch;
	}
	...
	public void setNumber(int number) {
		System.out.println("Settet 호출됨 - 2 ");
		this.number = number;
	}
	@Override
	public void powerOn() {
